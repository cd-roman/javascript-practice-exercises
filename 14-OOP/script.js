...
class StudentCl extends PersonCl2 {
  constructor(fullName, birthYear, course) {
    // First, we call the constructor function of the parent class using the super keyword
...
const hyundai = new EVCl("Hyundai", 120, 74);
console.log(hyundai);

hyundai.accelerate().brake().chargeBattery(90).accelerate();
