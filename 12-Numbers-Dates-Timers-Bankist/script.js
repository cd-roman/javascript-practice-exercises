...
console.log(+future); // 2142251380000
...
const options = {
  style: "unit", // style can be unit, percent, or currency
  unit: "mile-per-hour", // unit can be celsius, fahrenheit, mile-per-hour, etc.
};
